...
class FHNN:
    def __init__(self, NumberOfNeurons, a=None, b=None, c=None, I=None, V=None, W=None, t=0, scale = 0.02):
    ...
    def Plot(self, NeuronID=0, DownSampleRate=1, Number=1):
        FigureDict = dict()
...
#            ax.quiver(V1 , U1, DV1Scaled, DU1Scaled, (M), width=0.002, scale=100)#pivot='mid')
        ...
        plt.xlabel('V')
        plt.ylabel('w')
        plt.savefig(PlotPath+'FitzhughNagumo.png')
        plt.show()
        return [fig, ax]
